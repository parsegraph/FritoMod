--[[
-- An Environment is a staging point for the framework. It provides access 
--
--]]
...
Environment.runLevels = {
    ...
    -- A stage which guarantees no functionality. This is the first stage ever exposed to
    -- clients. The framework is usable at this stage.
