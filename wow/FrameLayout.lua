...
function FrameLayout:Constructor(frame)
	...
	-- Use upvalues here so we don't unnecessarily expose our internal
	-- implementation to clients.
	local layout = self;

	function frame:SetAllPoints(...)
		return layout:SetAllPoints(...);
	end;

	function frame:SetPoint(...)
		return layout:SetPoint(...);
	end;

	function frame:GetNumPoints(...)
		return layout:GetNumPoints(...);
	end;

	function frame:GetPoint(...)
		return layout:GetPoint(...);
	end;
end;
